...
diagnosed with ODD , ADD ( on medication ) , and a 'little bit of anxiety' ( direct quote from the doctor 😭 ) .

tonetags *needed* , if you don't provide them in some cases i'll usually overthink whatever you said . i'd
...
agere + audhd + multifandom ( SO many fandoms . ) + queer asf ( nonbinary/agender genderfluid [ gender is veryyy fluid ] + omniromantic sapphic w/ fem pref + xenogender / neopronouns user 
